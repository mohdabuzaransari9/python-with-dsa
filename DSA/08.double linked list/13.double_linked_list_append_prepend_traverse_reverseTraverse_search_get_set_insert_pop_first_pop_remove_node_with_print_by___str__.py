...
class DoublyLinkedList:
    ...
    def prepend(self,value):
        '''
        case 1: empty node
        case 2: double linked list exist
    ...
    def insert(self,index,value):
        '''
        case 1: handle insert at begining and insert at end
        case 2: handle insert at index<0 and index>length
    ...
    def pop_first(self):
        '''
        case 1: if we have only one node existed
        case 2: if double linked list is empty 
        '''
        if not self.head:
            return
    ...
    def pop(self):
        '''
        case 1: if only single node exist
        case 2: not even a single node exist
        '''
        if not self.head:
            return None
    ...
    def remove(self,index):
        '''
        case 1: index is for begining node
        case 2: index is for last node
